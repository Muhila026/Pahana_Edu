                                        ...
                                        <%
                                            ...
                                            if (userRoles != null) {
                                                for (UserRole userRole : userRoles) {
                                                    // Role-based filtering - ADMIN can only edit system users (ADMIN, MANAGER, STAFF)
                                                    boolean canEdit = false;
                                                    if ("ADMIN".equals(role)) {
                                                        // Admin can only edit ADMIN, MANAGER, STAFF (system users)
                                                        canEdit = "ADMIN".equals(userRole.getRoleName()) || 
                                                                 "MANAGER".equals(userRole.getRoleName()) || 
                                                                 "STAFF".equals(userRole.getRoleName());
                                                    } else if ("MANAGER".equals(role)) {
                                                        canEdit = "STAFF".equals(userRole.getRoleName());
                                                    }

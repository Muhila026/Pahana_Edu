...
<head>
    ...
    <title>Edit User - BookShop</title>
                ...
                <div class="form-section">
                    ...
                    <form action="UserServlet" method="POST" class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="help-text">Leave password field empty to keep the current password unchanged.</div>
                        </div>
                            ...
                            <select id="roleId" name="roleId" required>
                                ...
                                if (roles != null) {
                                    for (com.pahana.UserServlet.Role roleItem : roles) {
                                        String selected = (user.getRoleId() == roleItem.getRoleId()) ? "selected" : "";
                                %>
                                    <option value="<%= roleItem.getRoleId() %>" <%= selected %>><%= roleItem.getRoleName() %></option>
                                <%
                                    }
                                }
                                %>
                        ...
                        <div class="form-buttons">
                            <a href="UserServlet?action=list" class="btn btn-cancel">
                    ...
                    <div style="text-align: center; padding: 2rem;">
                        ...
                        <a href="UserServlet?action=list" class="btn btn-cancel" style="margin-top: 1rem;">

...
<head>
    ...
    <title>Edit Help Section - BookShop</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <h1 class="page-title">
                <i class="fas fa-edit me-3"></i>Edit Help Section
            </h1>
            <p class="page-subtitle">Update help content and information</p>
        </div>
        ...
        <div class="content-card">
            <h3 class="card-title">
                <i class="fas fa-edit"></i>Edit Help Section: <%= helpSection.getTitle() %>
                <div>
            ...
            <form action="HelpServlet" method="POST" id="helpForm">
                ...
                <div class="form-section">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" 
                               value="<%= helpSection.getTitle() != null ? helpSection.getTitle() : "" %>"
                ...
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i>Update Help Section
                    </button>
                    <a href="HelpServlet?action=view&help_id=<%= helpSection.getHelpId() %>" class="btn btn-secondary">
                        <i class="fas fa-eye"></i>View Help Section
                    </a>
                    <a href="HelpServlet?action=list" class="btn btn-danger">

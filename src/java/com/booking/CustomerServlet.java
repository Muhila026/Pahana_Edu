...
public class CustomerServlet extends HttpServlet {
    ...
    public static class CustomerFactory {
        public static Customer createCustomer(int customerId, String accountNumber, String name, 
        ...
        public static Customer createCustomerWithCredentials(int customerId, String accountNumber, 
                                                           String name, String address, String phone,
                                                           String username, String email, String password) {
            Customer customer = createCustomer(customerId, accountNumber, name, address, phone);
        ...
        // Create customer without account number (will be auto-generated)
        public static Customer createCustomerAutoAccount(int customerId, String name, 
                                                       String address, String phone) {
            Customer customer = new Customer();
            customer.setCustomerId(customerId);
            // accountNumber will be null, so it gets auto-generated
            customer.setName(name);
            customer.setAddress(address);
            customer.setPhone(phone);
            return customer;
        ...
        // Create customer with credentials without account number (will be auto-generated)
        public static Customer createCustomerWithCredentialsAutoAccount(int customerId, String name, 
                                                                      String address, String phone,
                                                                      String username, String email, String password) {
            Customer customer = createCustomerAutoAccount(customerId, name, address, phone);
            customer.setUsername(username);
            customer.setEmail(email);
            customer.setPassword(password);
            return customer;
    ...
    // Decorator Pattern - Customer Information Display
    public static abstract class CustomerInfoDecorator {
        protected Customer customer;
        
        public CustomerInfoDecorator(Customer customer) {
    ...
    public static class CustomerBasicInfoDecorator extends CustomerInfoDecorator {
        public CustomerBasicInfoDecorator(Customer customer) {
            super(customer);
        }
    ...
    public static class CustomerDetailedInfoDecorator extends CustomerInfoDecorator {
        public CustomerDetailedInfoDecorator(Customer customer) {
            super(customer);
        }
    ...
    public boolean createCustomer(Customer customer) {
        // Generate sequential account number if not provided
        if (customer.getAccountNumber() == null || customer.getAccountNumber().trim().isEmpty()) {
            ...
            System.out.println("Auto-generated account number: " + generatedAccountNumber);
        }
    ...
    public List<Customer> getAllCustomers() {
        ...
        String sql = "SELECT c.*, u.username as created_by_name, r.role_name FROM customers c " +
    ...
    private void handleCustomerRegistration(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (success) {
                System.out.println("Customer registered successfully: " + accountNumber);
                response.sendRedirect("login.jsp?message=Registration successful! You can now login with your username and password.");
            } else {
                System.err.println("Customer registration failed: " + accountNumber);
    ...
    private void handleCreateCustomer(HttpServletRequest request, HttpServletResponse response, HttpSession session)
        ...
        try {
            ...
            System.err.println("Customer creation error: " + e.getMessage());
    ...
    private void handleDeleteCustomer(HttpServletRequest request, HttpServletResponse response, HttpSession session)
        ...
        try {
            ...
            if (transactionCount > 0) {
                System.out.println("Customer deletion blocked: ID " + customerId + " has " + transactionCount + " transactions");
    ...
    private void handleViewCustomer(HttpServletRequest request, HttpServletResponse response, HttpSession session)
        ...
        try {
            ...
            System.err.println("Customer view error: " + e.getMessage());
    ...
    private void handleListCustomers(HttpServletRequest request, HttpServletResponse response, HttpSession session)
        ...
        try {
            ...
            System.err.println("Customer list error: " + e.getMessage());

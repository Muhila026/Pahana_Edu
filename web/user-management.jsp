...
<body>
            ...
            <div class="main-content">
                    ...
                    <form action="UserServlet" method="GET" class="search-form">
                        ...
                        <div class="form-group">
                            ...
                            <select id="roleFilter" name="roleFilter">
                                ...
                                <%
                                java.util.List<com.pahana.UserServlet.Role> roles = 
                                    (java.util.List<com.pahana.UserServlet.Role>) request.getAttribute("roles");
                                if (roles != null) {
                                    for (com.pahana.UserServlet.Role roleItem : roles) {
                                        String selected = (request.getAttribute("roleFilter") != null && 
                                                         request.getAttribute("roleFilter").equals(roleItem.getRoleName())) ? "selected" : "";
                                %>
                                    <option value="<%= roleItem.getRoleName() %>" <%= selected %>><%= roleItem.getRoleName() %></option>
                                <%
                                    }
                                }
                                %>
                ...
                <div class="users-section">
                    <table class="users-table">
                        ...
                        <tbody>
                            <%
                            java.util.List<com.pahana.UserServlet.User> users = 
                                (java.util.List<com.pahana.UserServlet.User>) request.getAttribute("users");
                            
                            if (users != null && !users.isEmpty()) {
                                for (com.pahana.UserServlet.User user : users) {
                                    String roleClass = "";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="user-role <%= roleClass %>">
                                            <%= user.getRoleName() != null ? user.getRoleName() : "No Role" %>
                                        </span>
                                    </td>
                                    <td><%= user.getCreatedAt() != null ? user.getCreatedAt().toString() : "N/A" %></td>
                                    <td>
                                        <div class="action-buttons">
                                            <a href="UserServlet?action=view&userId=<%= user.getUserId() %>" class="btn btn-view" title="View User">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="UserServlet?action=edit&userId=<%= user.getUserId() %>" class="btn btn-edit" title="Edit User">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button onclick="confirmDelete('<%= user.getUserId() %>', '<%= user.getUsername() %>')" class="btn btn-delete" title="Delete User">
                            ...
                            %>
                                <tr>
                                    <td colspan="7" style="text-align: center; padding: 2rem;">
                                        <h3 style="color: #724784; margin-bottom: 1rem;">No Users Found</h3>
    ...
    <div id="addUserModal" class="modal">
        <div class="modal-content">
            ...
            <h2 style="color: #724784; margin-bottom: 1rem;">Add New User</h2>
            <form action="UserServlet" method="POST" class="modal-form">
                ...
                <div class="form-group">
                    ...
                    <select id="roleId" name="roleId" required>
                        ...
                        if (roles != null) {
                            for (com.pahana.UserServlet.Role roleItem : roles) {
                        %>
                            <option value="<%= roleItem.getRoleId() %>"><%= roleItem.getRoleName() %></option>
                        <%
                            }
                        }
                        %>
